...
function handleWebhookData(req, res) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        if (body.object === "page") {
            ...
            for (const entry of body.entry) { // ✅ Use `for...of` instead of `.forEach()`
                console.log(entry, 'page      ++++++++++++ entry');
                if (entry.changes && entry.changes.length) {
                    let webhookEvent = entry.changes[0];
                    console.log(webhookEvent, 'page      ++++++++++++ entry');
                    if ((webhookEvent === null || webhookEvent === void 0 ? void 0 : webhookEvent.field) == 'feed' && ((_a = webhookEvent === null || webhookEvent === void 0 ? void 0 : webhookEvent.value) === null || _a === void 0 ? void 0 : _a.item) == 'comment') {
                        let customerId = (_c = (_b = webhookEvent === null || webhookEvent === void 0 ? void 0 : webhookEvent.value) === null || _b === void 0 ? void 0 : _b.from) === null || _c === void 0 ? void 0 : _c.id;
                        let post_id = (_d = webhookEvent === null || webhookEvent === void 0 ? void 0 : webhookEvent.value) === null || _d === void 0 ? void 0 : _d.post_id;
                        let comment_id = (_e = webhookEvent === null || webhookEvent === void 0 ? void 0 : webhookEvent.value) === null || _e === void 0 ? void 0 : _e.comment_id;
                        console.log(post_id, 'post_id +++++++++++++++++++++++++++');
                        // ✅ Fix: Await database queries properly
                        const automation = yield automation_model_1.default.find({ postId: post_id });
                        console.log(automation, 'automation +++++++++++++++++++++++++++');
                        if (!automation.length)
                            continue; // Skip if no automation is found
                        let userId = (_f = automation[0]) === null || _f === void 0 ? void 0 : _f.userId;
                        let pageId = (_g = automation[0]) === null || _g === void 0 ? void 0 : _g.pageId;
                        let replies = (_h = automation[0]) === null || _h === void 0 ? void 0 : _h.commentReplies;
                        ...
                        let randomReplyMessage = (0, getRandomItemFromArray_1.getRandomItem)(replies);
                        yield (0, endpoint_helper_1.replyToComment)(pageAccessToken, comment_id, randomReplyMessage);
                    }
                }
                // ✅ Fix: Await message handling as well
                if (entry.messaging && entry.messaging.length) {
                    let messagingData = entry.messaging[0];
                    const senderId = (_l = messagingData === null || messagingData === void 0 ? void 0 : messagingData.sender) === null || _l === void 0 ? void 0 : _l.id;
                    const recipientId = (_m = messagingData === null || messagingData === void 0 ? void 0 : messagingData.recipient) === null || _m === void 0 ? void 0 : _m.id;
                    const message = (_o = messagingData === null || messagingData === void 0 ? void 0 : messagingData.message) === null || _o === void 0 ? void 0 : _o.text;
                    let accountData = yield accounts_model_1.default.find({ profileId: recipientId });
                    const userId = (_p = accountData[0]) === null || _p === void 0 ? void 0 : _p.userId;
                    let leadsData = yield leads_model_1.default.find({ profileId: senderId });
                    let leadName = (_q = leadsData[0]) === null || _q === void 0 ? void 0 : _q.name;
                    if (leadName) {
                        ...
                        if (oldMessageData.length) {
                            yield message_model_1.default.findByIdAndUpdate((_r = oldMessageData[0]) === null || _r === void 0 ? void 0 : _r._id, messageData, { new: true });
                        }
                        else {
